 ...
 *   - Backgrounds/graphics 1:1 fidelity (Playwright's bundled Chromium renders them)
 *   - No HTML modifications required
 *   - Zero visual loss (the PDF is what the browser printed)
 *
 * Trade-off:
 *   - PDF text is no longer editable (edit the HTML if you need to change it)
 *
