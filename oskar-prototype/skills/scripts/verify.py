#!/usr/bin/env python3
"""
verify.py — a Playwright wrapper for verifying HTML produced by claude-design
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # slideshow mode: capture the first N slides one by one
...
def verify_html(html_path, viewports=None, slides=0, output_dir=None, show=False, wait=2000):
    ...
    with sync_playwright() as p:
        ...
        for viewport in viewports:
            ...
            if show:
                print("  (browser window will stay open; press Enter to close...)")
                input()
...
def main():
    ...
    parser.add_argument("--slides", type=int, default=0,
                        help="Slideshow mode: capture the first N slides (HTML must support ArrowRight to advance)")
