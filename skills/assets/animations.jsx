 ...
 * - Sprite: a time segment that shows between start/end and exposes local progress
 * - useTime(): read the global time (in seconds)
...
(function() {
  ...
  const Easing = {
    ...
    // Quick to start, slow to brake — gives digital elements a sense of physical weight
